...
class InnerDrawerState extends State<InnerDrawer> with SingleTickerProviderStateMixin {
  ...
  Widget _scaffold() {
    ...
    final Widget scaffoldChild = Stack(children: [widget.scaffold, invC ?? Container()].where((Widget a) => a.runtimeType.toString().toLowerCase() != 'container').toList().cast<Widget>());
          ...
          GestureDetector(
            ...
            child: RepaintBoundary(
              child: Stack(
                ...
                ].where((a) => a.runtimeType.toString().toLowerCase() != 'container').toList().cast<Widget>(),
              ),
            ),
          ),
        ],
